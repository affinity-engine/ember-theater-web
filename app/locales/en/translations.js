...
const theaters = {
  theaters: {
    ...
    fixtures: {
      emmaIntro: "Before proceeding, let's take a moment to talk about fixtures. Although they're not strictly necessary, they'll make developing most Ember Theater games far easier.",
      bitsyIntro: "I like easy! But what's a fixture?",
      emmaBigReveal: "We are.",
      bitsyBigReveal: "What?!! Really?!",
      emmaAttributes: "Really! But it's nothing to be worried about. I'm a fixture, you're a fixture, this classroom is a fixture.",
      bitsyWeird: "You're always telling me such weird things, Em!",
      emmaWeird: "Oh, uh, sorry Little Bit. I should have been more delicate in the way I told you that.",
      bitsyApology: "It's alright. Just, don't try to be so creepy next time, okay?",
      emmaApology: "Okay. ((#delay 150)) Anyway, as a fixture I'm just a set of attributes. Those attributes look something like this: <code>{ id: 'emma', height: 90, name: 'Emma', defaultExpression: 'neutral' }</code>.",
      bitsyXray: "Ew. . . . I feel like I'm looking at your x-ray or something.",
      emmaXray: "I actually think it's quite beautiful. In just a few words, that fixture summed up some of my most defining qualities.",
      bitsyYakChat: "Like a YakChat profile?",
      emmaYakChat: "Yeah, a lot like that.",
      bitsyWhy: "But why write one? Are our friends gonna look at it or something?",
      emmaWhy: "No, they probably won't. In this case, we're not writing fixtures for our friends. We're writing them for Ember Theater.",
      bitsyUse: "What does Ember Theater do with them?",
      emmaUse: "It refers to them anytime one of us appears on screen. Rather than say <code>{ id: 'emma', height: 90 }</code> every time you want to bring me on stage, you can just provide my <code>id</code>, 'emma'.",
      bitsy100: "So even if you're in like 100 scenes, I only have to define you once?",
      emma100: "Exactly! That's the beautiful thing about fixtures. They reduce duplication, making our lives as game developers that much easier!",
      bitsyConclude: "So how do we use them?",
      emmaConclude: "You'll find all the information you need below! Let's take a few moments to read over it, okay?"
    },
    backdrop: {
      intro: {
