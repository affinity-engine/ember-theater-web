...
const theaters = {
  theaters: {
    ...
    installation: {
      ...
      bitsyGreeting: "And this is Bitsy! And I'm gonna make a game!",
      emmaInstalling: "Yes, you are! But first, you've got to install the Ember Theater engine.",
      bitsyInstalling: "Oh, that's easy. I've installed lots of things before!",
      ...
      emmaNoWorries: "Actually, forget it, Bitsy. ((#delay 200)) You don't need to know what the command line is.",
      ...
      bitsyGuide: "Even the command line parts?",
      emmaUnderstand: "Yep, even those! ((#delay 300)) In time, if you want to get the most out of it, you'll want to really understand how the command line works. But for now, let's just get things up and running.",
      bitsyUnderstand: "Okay! That's great! Let's get started, Em!",
      emmaBye: "Yeah, that's the spirit! And don't rush it. This part can take awhile, but once you're done, you'll be able to make games with ease!",
      bitsyBye: "Ahhhh! I can't wait!",
    },
    configuration: {
      bitsyGrumble: "*grumble, grumble*",
      emmaEnter: "How's it coming along, Bitsy?",
      bitsyNotGreat: "It's awful! I want my game to be super special, but all Ember Theater games look the same!",
      emmaNotGreat: "Oh, I see why you're worried! But you know what? If you want your game to be special, you just have to configure it.",
      bitsyConfigure: "But I want to make the text boxes blue!",
      emmaConfigure: "Well, you can configure that, too! You can change almost everything in your <code>ember-theater/config.js</code> file. Just read over the documentation on this page.",
      bitsyBlue: "Okay ((#speed 5)) . . . .",
      bitsyBlue2: "Like this?!",
    ...
    character: {
      intro: {
        ...
        emmaTransition2: "Why thank you. ((#delay 200)) Now you try one.",
        ...
        bitsyInstanceConclude: "Let's never do that again, okay Em? ((#delay 750)) Is there anything else that a <code>Character</code> can do, though?",
        ...
        emmaExpression2: "Trust me, I know. ((#delay 250)) <code>expression</code> and <code>Text</code> are the real heart of theater, games, and life itself. And we can do them both.",
