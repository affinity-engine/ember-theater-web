  ...
  theaters: {
    ...
    character: {
      intro: {
        ...
        blixieCharacters: "Well, it's good to have you here! We'll be talking about <code>Characters</code> today. <code>Characters</code>, like you and me.",
        ...
        blixiePositionConfig: "Those are just some pre-defined positions, but you can add more in your config, too!",
        ...
        bebeTransition3: "And how about this one? <code>bebe.transition('callout.swing')</code>",
        blixieTransition4: "Bravo, Bebe!",
        bebeTransition4: "And! <code>bebe.transition('transition.bounceUpIn')</code>",
        blixieTransition5: "You're a natural at <code>transitions</code>! Now try chaining them together!",
        bebeTransition5: "Woah!!!!!!!",
        blixieInstance: "Congratulations, Bebe! You just chained together multiple <code>transitions</code>. I think you're ready for the next demo!",
        blixie2Instance: "Yeah, I think she's ready, too!",
        bebeInstance: "Woah, wait! Blixie!? How are there two of you?",
        ...
        bebePanic: "Ahhhh!!!!!!",
        blixiePanic: "Oh, Bebe, it's alright.",
        bebeForgive: "I-I know. It's just a little scary.",
        ...
        blixieName: "Exactly! Easy, right? <code>Characters</code> have the ability to change the way they speak <code>Text</code>, too. By default, my name appears as 'Blixie', but I can change it with <code>blixie.name('Blixmix')</code>",
        blixieName2: "See? And now I can change it back with <code>blixie.name('Blixie')</code>",
        bebeName: "Alright, then my name is no longer Bebe. Call me The World's Greatest Hacker!",
        bebesNewName: "World's Greatest Hacker",
        blixieNamePosition: "Okay, oh great hacker child. But there's one more lesson for you! You can change where your name appears with <code>bebe.namePosition('center')</code>. Options include 'left', 'right', and 'center', but you can add more in your config. Want to try it?",
        bebeNamePositionCenter: "<code>bebe.namePosition('center')</code>",
        bebeNamePositionLeft: "<code>bebe.namePosition('left')</code>",
        bebeNamePositionRight: "<code>bebe.namePosition('right')</code>",
        blixieNamePositionPraise: "Good job! You're now a fully fledged <code>Character</code>, ready to take on the world!",
        bebeBye: "Then what are we waiting for? We should start writing <code>Character</code> scripts!",
        blixieBye: "Good idea, oh great hacker child! Let's go!"
      }
    },
    choice: {
      clickMe: 'Click Me!',
