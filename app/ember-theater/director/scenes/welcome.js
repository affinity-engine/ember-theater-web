...
export default Scene.extend({
  ...
  script: async function() {
    ...
    await this.text('bebe', 'theaters.welcome.bebeMakeGames');
    await this.text('blixie', 'theaters.welcome.blixieMakeGames');
    this.expression('bebe', 'bebe-panic');
    await this.text('bebe', 'theaters.welcome.bebeShock');
    this.expression('bebe', 'bebe-laughing');
    await this.text('bebe', 'theaters.welcome.bebeFun');
    ...
    await this.text('bebe', 'theaters.welcome.bebeNext');
