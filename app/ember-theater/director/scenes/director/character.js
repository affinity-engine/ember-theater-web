...
export default Scene.extend({
  ...
  start: async function(script) {
    ...
    emma.delay(250).expression('emma-neutral');
    ...
    await bitsy.delay(1750).expression('bitsy-laughing').Text('theaters.character.intro.bitsyTransition').delay(2000);
    ...
    emma.delay(500).expression('emma-neutral');
    ...
    bitsy.delay(1000).expression('bitsy-surprised');
    ...
    emma2.delay(250).position('right').expression('emma-embarrassed');
    emma.delay(250).expression('emma-sad');
    ...
    await emma.delay(500).expression('emma-neutral').Text('theaters.character.intro.emmaExpression2');
